...
class AuthGateMiddleware:
    ...
    async def __call__(self, scope, receive, send):
        ...
        # CORS preflight: browsers never attach Authorization to an OPTIONS
        # preflight, so it must reach the inner CORSMiddleware which answers
        # it from the allowlist. The real request still needs a token.
