...
const zh = {
  ...
  'gleanings.radar.desc': '九个站的榜单按语区分成两段：中文热榜五家、技术榜单四家，各取前十。',
  'gleanings.radar.snapshot': '快照',
  'gleanings.radar.alive': '个源可用',
  'gleanings.radar.hint': '每源十条刻度，榜首在下。刻度只在同一个源内部比较 —— 各站的计数单位不一样，跨站比大小没有意义。',
...
const en: Record<keyof typeof zh, string> = {
  ...
  'gleanings.radar.desc': 'Nine boards in two zones: five Chinese trending lists and four tech boards, ten items each.',
  'gleanings.radar.snapshot': 'Snapshot',
  'gleanings.radar.alive': 'sources live',
  'gleanings.radar.hint': 'Ten ticks per source, leader at the bottom. Ticks only compare within one source — counting units differ, so cross-site magnitudes mean nothing.',
