...
const zh = {
  ...
  'gleanings.title': '拾遗',
  'gleanings.desc': '外面捡回来的，留在这一页：收藏的网页、star 的仓库、各站的榜单。',
  'gleanings.lede': '都是我拣过一遍的东西 —— 收藏的网页、star 的仓库，以及我每天扫一眼的那九个榜单。',
  'gleanings.index.aria': '收录模块',
  'gleanings.all.title': '收录',
  'gleanings.all.lede': '三个抽屉：我收藏的网页、GitHub 上 star 的仓库，与各站的榜单。',
  'gleanings.all.desc': '拾遗的三个抽屉 —— 收藏的网页与工具、GitHub 上 star 的仓库、九个站的榜单热点。',
  ...
  'gleanings.repos.catalog': '按主题过滤',
  'gleanings.stats.links': '条收藏',
  'gleanings.stats.repos': '个仓库',
  'gleanings.stats.topics': '个主题',
  'gleanings.stats.radar': '条榜单',
  'gleanings.radar.title': '雷达',
  'gleanings.radar.desc': '九个站的榜单并列在一处：中文热榜五家、技术榜单四家，各取前十。',
  'gleanings.radar.snapshot': '快照',
  'gleanings.radar.alive': '个源可用',
  'gleanings.radar.overview': '榜单速览',
  'gleanings.radar.hint':
    '每格十条刻度，榜首在下。刻度只在同一个源内部比较 —— 各站的计数单位不一样，跨站比大小没有意义。',
  'gleanings.radar.empty': '这一源暂时取不到',
  'gleanings.radar.stale': '暂时取不到',
  'gleanings.radar.allDown': '这一轮九个源都没取到。过一会儿再看，或者直接去各站。',
  'gleanings.radar.zone.hot': '中文热榜',
  'gleanings.radar.zone.tech': '技术榜单',
  'gleanings.radar.rankOnly': '按名次',
  'gleanings.radar.rankOnlyTitle': '这一源只给榜位、不给热度，刻度按名次画。',
  'gleanings.radar.sourceHome': '去源站看全部',
...
const en: Record<keyof typeof zh, string> = {
  ...
  'gleanings.desc': 'Things picked up elsewhere and kept here: bookmarks, starred repos, and the boards I watch.',
  'gleanings.lede': 'Everything here I went through myself — bookmarks, starred repos, and the nine boards I scan each day.',
  'gleanings.index.aria': 'Sections',
  'gleanings.all.title': 'Everything',
  'gleanings.all.lede': 'Three drawers: the pages I saved, the repos I starred on GitHub, and the boards I watch.',
  'gleanings.all.desc':
    'The three drawers of Gleanings — bookmarks, the repos I starred on GitHub, and the hot lists of nine sites.',
  ...
  'gleanings.repos.catalog': 'Filter by topic',
  'gleanings.stats.links': 'bookmarks',
  'gleanings.stats.repos': 'repos',
  'gleanings.stats.topics': 'topics',
  'gleanings.stats.radar': 'board entries',
  'gleanings.radar.title': 'Radar',
  'gleanings.radar.desc': 'Nine boards side by side: five Chinese trending lists and four tech boards, ten items each.',
  'gleanings.radar.snapshot': 'Snapshot',
  'gleanings.radar.alive': 'sources live',
  'gleanings.radar.overview': 'Board scan',
  'gleanings.radar.hint':
    'Ten ticks per cell, leader at the bottom. Ticks only compare within one source — counting units differ, so cross-site magnitudes mean nothing.',
  'gleanings.radar.empty': 'This source is unreachable right now',
  'gleanings.radar.stale': 'unreachable',
  'gleanings.radar.allDown': 'None of the nine sources came back this round. Try again later, or go straight to them.',
  'gleanings.radar.zone.hot': 'CN trending',
  'gleanings.radar.zone.tech': 'Tech boards',
  'gleanings.radar.rankOnly': 'by rank',
  'gleanings.radar.rankOnlyTitle': 'This source ranks without heat values, so the ticks follow rank.',
  'gleanings.radar.sourceHome': 'See all at the source',
